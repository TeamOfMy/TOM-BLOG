...
$app->get('/admin/medal', ['as' => 'task_index', 'uses' => 'App\Controller\Admin\MediaController@index']);
$app->get('/admin/medal_upload', ['as' => 'task_index', 'uses' => 'App\Controller\Admin\MediaController@medalUpload']);
$app->post('/admin/medal_upload_file', ['as' => '', 'uses' => 'App\Controller\Admin\MediaController@upload']);
